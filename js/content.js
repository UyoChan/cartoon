$(function(){
	...
	$.ajax({
		...
		type: 'GET',
		dataType: 'json',
		data: {data: 'http://japi.juhe.cn/comic/chapterContent?comicName='+name+'&id='+arr[index]+'&key=47e04da0dec9f782a4dcef0fdacb2ad5'},
	})
	.done(function(data) {
		console.log(data)
	...
	$(".shelter-inner a").on("touchstart",function(){
		...
		$.ajax({
			...
			type: 'GET',
			dataType: 'json',
			data: {data: 'http://japi.juhe.cn/comic/chapterContent?comicName='+name+'&id='+arr[_index]+'&key=47e04da0dec9f782a4dcef0fdacb2ad5'},
		})
		.done(function(data) {
			console.log(data)
			var data = data.result.imageList;
