$(function(){
	...
	$.ajax({
		...
		dataType:"json",
		type:"GET",
		data:{data:"http://japi.juhe.cn/comic/book?name="+name+"&type=&skip=&finish=&key=47e04da0dec9f782a4dcef0fdacb2ad5"}
	}).done(function(data){
	...
	$.ajax({
		...
		dataType:"json",
		type:"GET",
		data:{data:"http://japi.juhe.cn/comic/chapter?comicName="+name+"&skip=&key=47e04da0dec9f782a4dcef0fdacb2ad5"}
	}).done(function(data){
		var html = "",
			_html = ""
